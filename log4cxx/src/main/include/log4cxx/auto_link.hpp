...
// select architecture:
#ifdef _M_X64
#  define LOG4CXX_LIB_PLATFORM "-x64"
#else
#  define LOG4CXX_LIB_PLATFORM
#endif
...
#define LOG4CXX_LIB_NAME "log4cxxs-" LOG4CXX_LIB_TOOLSET LOG4CXX_LIB_PLATFORM LOG4CXX_LIB_THREAD_OPT LOG4CXX_LIB_RT_OPT LOG4CXX_CURRENT_VERSION ".lib"
#define APR_LIB_NAME "apr-" LOG4CXX_LIB_TOOLSET LOG4CXX_LIB_PLATFORM LOG4CXX_LIB_THREAD_OPT LOG4CXX_LIB_RT_OPT LOG4CXX_CURRENT_VERSION ".lib"
#define APRUTIL_LIB_NAME "aprutil-" LOG4CXX_LIB_TOOLSET LOG4CXX_LIB_PLATFORM LOG4CXX_LIB_THREAD_OPT LOG4CXX_LIB_RT_OPT LOG4CXX_CURRENT_VERSION ".lib"
