...
#define LOG4CXX_HAS_PTHREAD_SELF 0
#define LOG4CXX_HAS_PTHREAD_SIGMASK 0
#define LOG4CXX_HAS_PTHREAD_SETNAME 0
#define LOG4CXX_HAS_PTHREAD_GETNAME 0
#define LOG4CXX_HAS_THREAD_LOCAL 1

#define LOG4CXX_EXPAND_CONFIG_ENV_VAR 1
#endif
